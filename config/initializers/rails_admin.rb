# RailsAdmin config file. Generated on October 11, 2012 21:08
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Cocktaildepot', 'Admin']
  ...
  # config.excluded_models = ['Tag', 'Ingredient']

  # Include specific models (exclude the others):
  # config.included_models = ['Admin', 'Category', 'Tag']
